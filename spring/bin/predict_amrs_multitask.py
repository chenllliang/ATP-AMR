...
from spring_amr.utils import instantiate_loader, instantiate_model_and_tokenizer_multitask,instantiate_real_multitask_loader
...
if __name__ == '__main__':
    ...
    loader = instantiate_real_multitask_loader(
        args.datasets,
        {"amr":args.datasets},
        {"amr":args.datasets},
        tokenizer,
