...
from spring_amr.dataset import AMRDataset, AMRDatasetTokenBatcherAndLoader,AMRDataset_Index,DpPretrainDataset, MultiTaskDataset
from spring_amr.modeling_bart import AMRBartForConditionalGeneration
from spring_amr.tokenization_bart import AMRBartTokenizer, PENMANBartTokenizer,MultiTaskAmrTokenizer


def instaniate_model_tokenizer_cl(name,checkpoint,dropout,attention_dropout):
...
def instaniate_tokenizer(name):
    pass



def instantiate_model_and_tokenizer_multitask(name=None,
        checkpoint=None,
    ...
    tokenizer = MultiTaskAmrTokenizer.from_pretrained(
            tokenizer_name,
