...
def get_match_tributes(tributes_parse,tributes_gold,best_mapping):
...
def get_best_match_tributes(instance1, attribute1, relation1,
...
# HACK #
def score_doc_level_amr_pairs(f1, f2, justinstance=False, justattribute=False, justrelation=False):
