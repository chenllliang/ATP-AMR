...
gold = list(filter(lambda x:x!='', gold))
...
print ('Reentrancies -> P:', "{0:.3f}".format(float(pr)), ', R:', "{0:.3f}".format(float(rc)), ', F:', "{0:.3f}".format(float(f)))
pr, rc, f = smatch.main(srl_pred, srl_gold, True)
print ('SRL -> P:', "{0:.3f}".format(float(pr)), ', R:', "{0:.3f}".format(float(rc)), ', F:', "{0:.3f}".format(float(f)))
